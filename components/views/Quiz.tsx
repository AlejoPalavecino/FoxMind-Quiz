...
const Quiz: React.FC<QuizProps> = ({ onQuizEnd }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-6 bg-light-card dark:bg-dark-card rounded-xl shadow-2xl">
      {/* Top Bar */}
        ...
        {currentQuestion.options.map((option, index) => {
          ...
          return (
            <button
              ...
              disabled={isAnswered}
              className={`p-4 rounded-lg text-left w-full transition-all duration-200 ${buttonClass}`}
            >
